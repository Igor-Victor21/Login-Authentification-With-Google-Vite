...
function LoginSuccessful() {
  ...
  useEffect(() => {
    const fetchAdminCheck = async () => {
      try {
        const response = await fetch("https://complete-api-in-nodejs-firebase-auth.onrender.com/admin/dashboard", {
          credentials: "include"
        });
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await fetch('https://complete-api-in-nodejs-firebase-auth.onrender.com/users', {
          credentials: 'include'
        });
  ...
  const handleCreateUser = async () => {
    try {
      const response = await fetch('https://complete-api-in-nodejs-firebase-auth.onrender.com/users', {
        method: 'POST',
  ...
  const handleDeleteUser = async (uid: string) => {
    ...
    try {
      const res = await fetch(`https://complete-api-in-nodejs-firebase-auth.onrender.com/users/${uid}`, {
        method: 'DELETE',
        credentials: 'include'
      });
  ...
  const handlePromoteUser = async (uid: string) => {
    try {
      const res = await fetch(`https://complete-api-in-nodejs-firebase-auth.onrender.com/make-admin/${uid}`, {
        method: 'POST',
        credentials: 'include'
      });
      if (res.ok) {
  ...
  const handleDemoteUser = async (uid: string) => {
    try {
      const res = await fetch(`https://complete-api-in-nodejs-firebase-auth.onrender.com/remove-admin/${uid}`, {
        method: 'POST',
        credentials: 'include'
      });
      if (res.ok) {
